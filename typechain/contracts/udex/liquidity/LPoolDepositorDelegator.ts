...
export interface LPoolDepositorDelegatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface LPoolDepositorDelegator extends BaseContract {
  connect(runner?: ContractRunner | null): LPoolDepositorDelegator;
  waitForDeployment(): Promise<this>;

  interface: LPoolDepositorDelegatorInterface;
