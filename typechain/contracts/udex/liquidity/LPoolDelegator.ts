...
export interface LPoolDelegatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface LPoolDelegator extends BaseContract {
  connect(runner?: ContractRunner | null): LPoolDelegator;
  waitForDeployment(): Promise<this>;

  interface: LPoolDelegatorInterface;
