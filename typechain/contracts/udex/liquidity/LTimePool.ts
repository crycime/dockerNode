...
export interface LTimePoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "accrualBlockNumber"
...
export interface LTimePool extends BaseContract {
  connect(runner?: ContractRunner | null): LTimePool;
  waitForDeployment(): Promise<this>;

  interface: LTimePoolInterface;
