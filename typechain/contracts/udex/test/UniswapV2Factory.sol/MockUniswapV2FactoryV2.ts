...
export interface MockUniswapV2FactoryV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allPairs"
      | "allPairsLength"
...
export interface MockUniswapV2FactoryV2 extends BaseContract {
  connect(runner?: ContractRunner | null): MockUniswapV2FactoryV2;
  waitForDeployment(): Promise<this>;

  interface: MockUniswapV2FactoryV2Interface;
