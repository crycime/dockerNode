...
export interface MockUniswapV3PairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "burn"
      | "collect"
  ...
  encodeFunctionData(
    functionFragment: "setPreviousPrice",
...
export interface MockUniswapV3Pair extends BaseContract {
  connect(runner?: ContractRunner | null): MockUniswapV3Pair;
  waitForDeployment(): Promise<this>;

  interface: MockUniswapV3PairInterface;
  ...
  setPreviousPrice: TypedContractMethod<
  ...
  >;
  getFunction(
    nameOrSignature: "setPreviousPrice"
  ): TypedContractMethod<
    [tokenA: AddressLike, tokenB: AddressLike, price: BigNumberish],
    [void],
    "nonpayable"
