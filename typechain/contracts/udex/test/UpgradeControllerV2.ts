...
export interface UpgradeControllerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "addPublicPool"
...
export interface UpgradeControllerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradeControllerV2;
  waitForDeployment(): Promise<this>;

  interface: UpgradeControllerV2Interface;
  ...
  setVersion: TypedContractMethod<[], [void], "nonpayable">;
