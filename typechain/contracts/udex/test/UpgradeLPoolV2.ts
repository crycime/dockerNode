...
export interface UpgradeLPoolV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "accrualBlockNumber"
...
export interface UpgradeLPoolV2 extends BaseContract {
  connect(runner?: ContractRunner | null): UpgradeLPoolV2;
  waitForDeployment(): Promise<this>;

  interface: UpgradeLPoolV2Interface;
