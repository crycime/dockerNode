...
export interface XOLEDelegatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface XOLEDelegator extends BaseContract {
  connect(runner?: ContractRunner | null): XOLEDelegator;
  waitForDeployment(): Promise<this>;

  interface: XOLEDelegatorInterface;
