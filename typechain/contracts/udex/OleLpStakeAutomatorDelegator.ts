...
export interface OleLpStakeAutomatorDelegatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface OleLpStakeAutomatorDelegator extends BaseContract {
  connect(runner?: ContractRunner | null): OleLpStakeAutomatorDelegator;
  waitForDeployment(): Promise<this>;

  interface: OleLpStakeAutomatorDelegatorInterface;
