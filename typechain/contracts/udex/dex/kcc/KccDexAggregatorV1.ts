...
export interface KccDexAggregatorV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
  ...
  encodeFunctionData(
    functionFragment: "mojitoFactory",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface KccDexAggregatorV1 extends BaseContract {
  connect(runner?: ContractRunner | null): KccDexAggregatorV1;
  waitForDeployment(): Promise<this>;

  interface: KccDexAggregatorV1Interface;
  ...
  initialize: TypedContractMethod<
    [_mojitoFactory: AddressLike, _unusedFactory: AddressLike],
    [void],
    "nonpayable"
  >;

  mojitoFactory: TypedContractMethod<[], [string], "view">;
