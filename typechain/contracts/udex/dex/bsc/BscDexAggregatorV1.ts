...
export interface BscDexAggregatorV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface BscDexAggregatorV1 extends BaseContract {
  connect(runner?: ContractRunner | null): BscDexAggregatorV1;
  waitForDeployment(): Promise<this>;

  interface: BscDexAggregatorV1Interface;
  ...
  initialize: TypedContractMethod<
    [_pancakeFactory: AddressLike, _unsedFactory: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  pancakeFactory: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "pancakeFactory"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
