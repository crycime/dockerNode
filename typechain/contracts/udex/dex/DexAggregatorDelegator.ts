...
export interface DexAggregatorDelegatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface DexAggregatorDelegator extends BaseContract {
  connect(runner?: ContractRunner | null): DexAggregatorDelegator;
  waitForDeployment(): Promise<this>;

  interface: DexAggregatorDelegatorInterface;
