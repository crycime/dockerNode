...
export interface ArbitrumDexAggregatorV1Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface ArbitrumDexAggregatorV1 extends BaseContract {
  connect(runner?: ContractRunner | null): ArbitrumDexAggregatorV1;
  waitForDeployment(): Promise<this>;

  interface: ArbitrumDexAggregatorV1Interface;
