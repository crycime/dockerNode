...
import type {
  MockOpenLev,
  MockOpenLevInterface,
} from "../../../contracts/mocks/MockOpenLev";
...
type MockOpenLevConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: MockOpenLevConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class MockOpenLev__factory extends ContractFactory {
  constructor(...args: MockOpenLevConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override getDeployTransaction(
    ...
    return super.getDeployTransaction(_dexAgg, overrides || {});
  }
  override deploy(
    _dexAgg: AddressLike,
    overrides?: NonPayableOverrides & { from?: string }
  ) {
    return super.deploy(_dexAgg, overrides || {}) as Promise<
      MockOpenLev & {
        deploymentTransaction(): ContractTransactionResponse;
      }
    >;
  }
  override connect(runner: ContractRunner | null): MockOpenLev__factory {
    return super.connect(runner) as MockOpenLev__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): MockOpenLevInterface {
    return new Interface(_abi) as MockOpenLevInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): MockOpenLev {
    return new Contract(address, _abi, runner) as unknown as MockOpenLev;
  }
}
