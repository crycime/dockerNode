...
export interface OPLimitOrderDelegatorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptAdmin"
      | "admin"
...
export interface OPLimitOrderDelegator extends BaseContract {
  connect(runner?: ContractRunner | null): OPLimitOrderDelegator;
  waitForDeployment(): Promise<this>;

  interface: OPLimitOrderDelegatorInterface;
