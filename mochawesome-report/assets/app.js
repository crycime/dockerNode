/*! mochawesome-report-generator 3.1.5 | https://github.com/adamgruber/mochawesome-report-generator */ !(function(e) {
    var t = {};
    function n(r) {
                    ...
                    (z = T.timezone),
                        (M =
                            ((F = k.exec(z))
                                ? 0
                                : (F = E.exec(z))
                                ? ((U = 60 * parseInt(F[2], 10)), '+' === F[1] ? -U : U)
                                : (F = O.exec(z))
                                ? ((U = 60 * parseInt(F[2], 10) + parseInt(F[3], 10)), '+' === F[1] ? -U : U)
                                : 0) * i);
                else {
                    var A = j + D,
                        I = new Date(A);
                ...
                for (var e = [], t = 0; t < arguments.length; t++) {
                    ...
                    if (r) {
                        ...
                        if ('string' === a || 'number' === a) e.push((this && this[r]) || r);
                            ...
                            for (var i in r) n.call(r, i) && r[i] && e.push((this && this[i]) || i);
                    }
                }
                return e.join(' ');
            }
    ...
    function(e, t, n) {
            ...
            return w(function(n, o, a, i, s) {
                ...
                return Object(r.untracked)(function() {
                    if ('function' != typeof t)
                        return new Error(
                            'Property `' + s + '` of component `' + a + '` has invalid PropType notation.'
                        );
        ...
        function R(e, t, n) {
            var r,
                a,
                i = 'inject-' + (t.displayName || t.name || (t.constructor && t.constructor.name) || 'Unknown');
            n && (i += '-with-' + n);
            ...
            componentWillMount: function() {
                ...
                if (!0 !== F) {
                    ...
                    this.render = function() {
                        return (
                            ((u = new r.Reaction(t + '#' + n + '.render()', function() {
                                if (
                                    !l &&
                                    ((l = !0),
        ...
        function Z(e, t) {
            ...
            if (
                ...
                !(
                    'function' != typeof a ||
                    (a.prototype && a.prototype.render) ||
                    a.isReactClass ||
                    o.Component.isPrototypeOf(a)
                ))
            )
                return Z(
                    ((r = n = (function(e) {
                        function t() {
                            return (
                                u(this, t), f(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments))
                            );
                        }
                        return (
                            c(t, e),
                    ...
                    (n.displayName = a.displayName || a.name),
                    (n.contextTypes = a.contextTypes),
                    (n.propTypes = a.propTypes),
                    (n.defaultProps = a.defaultProps),
                    r)
                );
            if (!a) throw new Error("Please pass a valid component to 'observer'");
            return (
                (function(e) {
                    G(e, 'componentWillMount', !0),
        ...
        var ee,
            ...
            ne = function(e, t, n, r, o) {
                ...
                return 'function' == typeof e[t] && 'function' == typeof e[a]
                    ? new Error('Invalid prop,do not use children and render in the same time in`' + n)
                    : 'function' != typeof e[t] && 'function' != typeof e[a]
                    ? new Error(
                          'Invalid prop `' +
                              o +
                              '` of type `' +
        ...
        var re = { children: !0, key: !0, ref: !0 },
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                for (var r in this.props)
                                    re[r] || 'suppressChangedStoreWarning' === r || (e[r] = this.props[r]);
                                return { mobxStores: e };
                            }
                        },
                        {
            ...
            (ee.contextTypes = { mobxStores: j }),
            (ee.childContextTypes = { mobxStores: j.isRequired }),
            te);
        ...
        if (
            'object' ===
            ('undefined' == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ ? 'undefined' : s(__MOBX_DEVTOOLS_GLOBAL_HOOK__))
        ) {
            ...
            function(e) {
                ...
                var a = (function() {
                        function e(e) {
                            void 0 === e && (e = 'Atom@' + tt()),
                                ...
                                (this.lowestObserverState = Et.NOT_TRACKING);
                        }
                        return (
                            ...
                            (e.prototype.reportChanged = function() {
                                Vt(),
                                    (function(e) {
                                        ...
                                        for (; n--; ) {
                                            var r = t[n];
                                            r.dependenciesState === Et.UP_TO_DATE &&
                                                (r.isTracing !== Ot.NONE && $t(r, e), r.onBecomeStale()),
                                                (r.dependenciesState = Et.STALE);
                                        }
                                    })(this),
                                    Yt();
                            }),
                ...
                (k = T),
                    ...
                    void 0 !== Object.setPrototypeOf
                        ...
                        : void 0 !== k.prototype.__proto__
                        ? (k.prototype.__proto__ = E)
                        : (k.prototype = E),
                ...
                var C = (function() {
                        function e(e, t, n, r) {
                            (this.array = n),
                                ...
                                (this.atom = new a(e || 'ObservableArray@' + tt())),
                    ...
                    N = (function(e) {
                        function t(t, n, r, o) {
                            ...
                            return (
                                ...
                                O && Object.defineProperty(i.array, '0', P),
                                a
                            );
                        }
                        return (
                            ...
                            (t.prototype.move = function(e, t) {
                                function n(e) {
                                    ...
                                    if (e >= t)
                                        throw new Error(
                                            '[mobx.array] Index out of bounds: ' + e + ' is not smaller than ' + t
                                        );
                                }
                ...
                w(N.prototype, function() {
                    ...
                    [
                        ...
                        rt('function' == typeof t, "Base function not defined on Array prototype: '" + e + "'"),
                            mt(N.prototype, e, function() {
                    ...
                    L = (function(e) {
                        function t(t, n, r, o) {
                            ...
                            return (
                                ...
                                o && h() && m({ type: 'create', object: a, newValue: a.value }),
                                a
                            );
                        }
                        return (
                            ...
                            (t.prototype.set = function(e) {
                                ...
                                if ((e = this.prepareNewValue(e)) !== R) {
                                    var n = h();
                                    n && v({ type: 'update', object: this, newValue: e, oldValue: t }),
                                        this.setNewValue(e),
                                        n && b();
                                }
                            }),
                            ...
                            (t.prototype.setNewValue = function(e) {
                                ...
                                (this.value = e),
                                    this.reportChanged(),
                                    f(this) && p(this, { type: 'update', object: this, newValue: e, oldValue: t });
                            }),
                ...
                function B(e, t) {
                    rt('function' == typeof t, U('m026')),
                        rt('string' == typeof e && e.length > 0, "actions should have valid names, got: '" + e + "'");
                    var n = function() {
                    ...
                    try {
                        ...
                        !(function(e) {
                            $(e.prevAllowStateChanges),
                                Yt(),
                                nn(e.prevDerivation),
                                e.notifySpy && b({ time: Date.now() - e.startTime });
                        })(o);
                    }
                }
                function V(e) {
                ...
                function q(e, t, n, r, o) {
                    function a(a, i, s, u, l) {
                        if (
                            ...
                            ht(a, '__mobxLazyInitializers') ||
                                mt(
                                    a,
                                    '__mobxLazyInitializers',
                                    (a.__mobxLazyInitializers && a.__mobxLazyInitializers.slice()) || []
                                );
                            var c = s.value,
                                f = s.initializer;
                            return (
                                a.__mobxLazyInitializers.push(function(t) {
                        ...
                        var d = {
                            ...
                            get: function() {
                                return (
                                    (this.__mobxInitializedProps && !0 === this.__mobxInitializedProps[i]) ||
                                        G(this, i, void 0, e, u, s),
                                    t.call(this, i)
                                );
                            },
                            set: function(t) {
                        ...
                        return (
                            (arguments.length < 3 || (5 === arguments.length && l < 3)) &&
                ...
                function G(e, t, n, r, o, a) {
                    ht(e, '__mobxInitializedProps') || mt(e, '__mobxInitializedProps', {}),
                ...
                function X(e) {
                    !0 !== e.__mobxDidRunLazyInitializers &&
                        ...
                        (mt(e, '__mobxDidRunLazyInitializers', !0),
                ...
                var Q = q(
                    ...
                    J = function(e, t, n, r) {
                        return 1 === arguments.length && 'function' == typeof e
                            ? B(e.name || '<unnamed action>', e)
                            : 2 === arguments.length && 'function' == typeof t
                            ? B(e, t)
                            : 1 === arguments.length && 'string' == typeof e
                            ? ee(e)
                            : ee(t).apply(null, arguments);
                    };
                function ee(e) {
                    return function(t, n, r) {
                        if (r && 'function' == typeof r.value)
                            return (r.value = B(e, r.value)), (r.enumerable = !1), (r.configurable = !0), r;
                ...
                function te(e, t, n) {
                    ...
                    return (
                        rt('function' == typeof o, U('m002')),
                        rt(0 === o.length, U('m003')),
                        rt('string' == typeof r && r.length > 0, "actions should have valid names, got: '" + r + "'"),
                        H(r, o, a, void 0)
                    );
                }
                function ne(e) {
                ...
                function fe(e, t, n) {
                    ...
                    'string' == typeof e
                        ? ((r = e), (o = t), (a = n))
                        : ((r = e.name || 'Autorun@' + tt()), (o = e), (a = t)),
                        rt('function' == typeof o, U('m004')),
                        rt(!1 === ne(o), U('m005')),
                        a && (o = o.bind(a));
                ...
                function pe(e, t, n, r) {
                    ...
                    'string' == typeof e
                        ? ((o = e), (a = t), (i = n), (s = r))
                        : ((o = e.name || 'AutorunAsync@' + tt()), (a = e), (i = t), (s = n)),
                        rt(!1 === ne(a), U('m006')),
                        void 0 === i && (i = 1),
                        s && (a = a.bind(s));
                    var u = !1,
                ...
                function he(e, t, n) {
                    var r;
                    arguments.length > 3 && nt(U('m007')),
                        Be(e) && nt(U('m008')),
                        ((r = 'object' == typeof n ? n : {}).name = r.name || e.name || t.name || 'Reaction@' + tt()),
                        (r.fireImmediately = !0 === n || !0 === r.fireImmediately),
                        (r.delay = r.delay || 0),
                        (r.compareStructural = r.compareStructural || r.struct || !1),
                        (t = J(r.name, r.context ? t.bind(r.context) : t)),
                        r.context && (e = e.bind(r.context));
                    var o,
                        a = !0,
                        i = !1,
                ...
                var me = (function() {
                    function e(e, t, n, r, o) {
                        (this.derivation = e),
                            (this.scope = t),
                            (this.equals = n),
                            (this.dependenciesState = Et.NOT_TRACKING),
                            (this.observing = []),
                            ...
                            (this.runId = 0),
                            (this.lastAccessedBy = 0),
                            (this.lowestObserverState = Et.UP_TO_DATE),
                            (this.unboundDepsCount = 0),
                            (this.__mapid = '#' + tt()),
                            (this.value = new qt(null)),
                            (this.isComputing = !1),
                            (this.isRunningSetter = !1),
                            (this.isTracing = Ot.NONE),
                            (this.name = r || 'ComputedValue@' + tt()),
                            o && (this.setter = B(r + '-setter', o));
                    }
                    return (
                        (e.prototype.onBecomeStale = function() {
                            !(function(e) {
                                ...
                                for (; n--; ) {
                                    var r = t[n];
                                    r.dependenciesState === Et.UP_TO_DATE &&
                                        ((r.dependenciesState = Et.POSSIBLY_STALE),
                                        r.isTracing !== Ot.NONE && $t(r, e),
                                        r.onBecomeStale());
                                }
                            })(this);
                        }),
                        ...
                        (e.prototype.get = function() {
                            rt(!this.isComputing, 'Cycle detected in computation ' + this.name, this.derivation),
                                0 === Ct.inBatch
                                    ? (Vt(),
                                      Xt(this) &&
                                          (this.isTracing !== Ot.NONE &&
                                          ...
                                          (function(e) {
                                              ...
                                              for (; n--; ) {
                                                  ...
                                                  r.dependenciesState === Et.POSSIBLY_STALE
                                                      ? (r.dependenciesState = Et.STALE)
                                                      : r.dependenciesState === Et.UP_TO_DATE &&
                                                        (e.lowestObserverState = Et.UP_TO_DATE);
                                              }
                                          })(this));
                            var e = this.value;
                        ...
                        (e.prototype.trackAndCompute = function() {
                            ...
                            var e = this.value,
                                t = this.dependenciesState === Et.NOT_TRACKING,
                                n = (this.value = this.computeValue(!0));
                            return t || Gt(e) || Gt(n) || !this.equals(e, n);
                        }),
                        (e.prototype.computeValue = function(e) {
                            var t;
                            if (((this.isComputing = !0), Ct.computationDepth++, e))
                                t = Zt(this, this.derivation, this.scope);
                            else
                                try {
                ...
                function be(e, t) {
                    ...
                    rt(Object.isExtensible(e), U('m035')),
                        ft(e) || (t = (e.constructor.name || 'ObservableObject') + '@' + tt()),
                        t || (t = 'ObservableObject@' + tt());
                    var n = new ge(e, t);
                    return vt(e, '$mobx', n), n;
                }
                function ye(e, t, n, r) {
                    if (e.values[t] && !ve(e.values[t]))
                        return (
                            rt(
                                'value' in n,
                                'The property ' +
                    ...
                    if ('value' in n)
                        if (Be(n.value)) {
                            ...
                            ne(n.value) && !0 === n.value.autoBind
                                ? re(e.target, t, n.value.originalFn)
                                : ve(n.value)
                                ? (function(e, t, n) {
                                      var r = e.name + '.' + t;
                                ...
                                : _e(e, t, n.value, r);
                    else xe(e, t, n.get, n.set, ce.default, !0);
                }
                function _e(e, t, n, r) {
                    ...
                    (n = (e.values[t] = new L(n, r, e.name + '.' + t, !1)).value),
                        ...
                        (function(e, t, n, r) {
                            var o = f(e),
                                a = h(),
                                i = o || a ? { type: 'add', object: t, name: n, newValue: r } : null;
                            a && v(i);
                            o && p(e, i);
                            a && b();
                        })(e, e.target, t, n);
                ...
                function xe(e, t, n, r, o, a) {
                    a && bt(e.target, t),
                        (e.values[t] = new me(n, e.target, o, e.name + '.' + t, r)),
                        a && Object.defineProperty(e.target, t, Ee(t));
                }
                var we = {},
                    ke = {};
                function Ee(e) {
                ...
                function je(e, t, n) {
                    rt(arguments.length >= 2, U('m014')),
                        rt('object' == typeof e, U('m015')),
                        rt(!Ze(e), U('m016')),
                ...
                function He(e, t) {
                    return (
                        rt(!Be(t), 'Modifiers cannot be nested'),
                ...
                Object.keys(ze).forEach(function(e) {
                    ...
                    (Fe.deep.struct = Fe.struct),
                    (Fe.ref.struct = function() {
                ...
                var Xe = {},
                    Ke = (function() {
                        function e(e, t, n) {
                            void 0 === t && (t = Ve),
                                void 0 === n && (n = 'ObservableMap@' + tt()),
                                (this.enhancer = t),
                                (this.name = n),
                                (this.$mobx = Xe),
                                (this._data = Object.create(null)),
                                (this._hasMap = Object.create(null)),
                                (this._keys = new N(void 0, We, this.name + '.keys()', !0)),
                                (this.interceptors = null),
                                (this.changeListeners = null),
                        ...
                        return (
                            ...
                            (e.prototype.has = function(e) {
                                return (
                                    !!this.isValidKey(e) &&
                                    ((e = '' + e),
                                    this._hasMap[e] ? this._hasMap[e].get() : this._updateHasMapEntry(e, !1).get())
                                );
                            }),
                            ...
                            (e.prototype.delete = function(e) {
                                var t = this;
                                if (
                                    (this.assertValidKey(e), (e = '' + e), u(this)) &&
                                    !(o = c(this, { type: 'delete', object: this, name: e }))
                                )
                                    return !1;
                                if (this._has(e)) {
                                    var n = h(),
                            ...
                            (e.prototype._updateHasMapEntry = function(e, t) {
                                ...
                                return (
                                    n
                                        ? n.setNewValue(t)
                                        : (n = this._hasMap[e] = new L(t, We, this.name + '.' + e + '?', !1)),
                                    n
                                );
                            }),
                            ...
                            (e.prototype._addValue = function(e, t) {
                                ...
                                var r = h(),
                                    o = f(this),
                                    a = o || r ? { type: 'add', object: this, name: e, newValue: t } : null;
                                r && v(a), o && p(this, a), r && b();
                            }),
                            (e.prototype.get = function(e) {
                                return (
                                    (e = '' + e),
                                    this.has(e) ? this.dehanceValue(this._data[e].get()) : this.dehanceValue(void 0)
                                );
                            }),
                            (e.prototype.dehanceValue = function(e) {
                                return void 0 !== this.dehancer ? this.dehancer(e) : e;
                ...
                function Qe(e) {
                    return (
                        at('`mobx.map` is deprecated, use `new ObservableMap` or `mobx.observable.map` instead'),
                        Fe.map(e)
                    );
                }
                ...
                var Et,
                    Ot,
                    St = ['mobxGuid', 'resetId', 'spyListeners', 'strictMode', 'runId'],
                    Tt = (function() {
                        return function() {
                            (this.version = 5),
                    ...
                    if ('object' == typeof e && null !== e) {
                        ...
                        if (Ze(e)) {
                            ...
                            return void 0 === t
                                ? Dt(n._keys)
                                : (rt(
                                      !!(r = n._data[t] || n._hasMap[t]),
                                      "the entry '" + t + "' does not exist in the observable map '" + It(e) + "'"
                                  ),
                                  r);
                        }
                        var r;
                        if ((X(e), t && !e.$mobx && e[t], Te(e)))
                            return t
                                ? (rt(
                                      !!(r = e.$mobx.values[t]),
                ...
                function At(e, t) {
                    return (
                        ...
                        void 0 !== t
                            ...
                            : Ze(e)
                            ? e
                            : (X(e), e.$mobx ? e.$mobx : void rt(!1, 'Cannot obtain administration from ' + e))
                    );
                }
                function It(e, t) {
                ...
                function Qt(e) {
                    ...
                    Ct.computationDepth > 0 && t && nt(U('m031') + e.name),
                        !Ct.allowStateChanges && t && nt(U(Ct.strictMode ? 'm030a' : 'm030b') + e.name);
                }
                function Zt(e, t, n) {
                    rn(e),
                ...
                function an(e, t) {
                    return (
                        at('`whyRun` is deprecated in favor of `trace`'),
                        (e = un(arguments)) ? (ve(e) || mn(e) ? on(e.whyRun()) : nt(U('m025'))) : on(U('m024'))
                    );
                }
                function sn() {
                    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                    ...
                    r.isTracing === Ot.NONE && console.log("[mobx.trace] '" + r.name + "' tracing enabled"),
                        (r.isTracing = n ? Ot.BREAK : Ot.LOG);
                }
                function un(e) {
                    switch (e.length) {
                        case 0:
                ...
                var ln = (function() {
                    ...
                    return (
                        ...
                        (e.prototype.runReaction = function() {
                            this.isDisposed ||
                                ...
                                Xt(this) &&
                                    ...
                                    this.onInvalidate(),
                                    this._isTrackPending && h() && m({ object: this, type: 'scheduled-reaction' })),
                                Yt());
                        }),
                        (e.prototype.track = function(e) {
                            ...
                            var t,
                                n = h();
                            n && ((t = Date.now()), v({ object: this, type: 'reaction', fn: e })),
                                (this._isRunning = !0);
                            var r = Zt(this, e, void 0);
                            (this._isRunning = !1),
                                (this._isTrackPending = !1),
                                this.isDisposed && Jt(this),
                        ...
                        (e.prototype.reportExceptionInDerivation = function(e) {
                            ...
                            if (this.errorHandler) this.errorHandler(e, this);
                                ...
                                var n =
                                    ...
                                    r = U('m037');
                                console.error(n || r, e),
                                    h() && m({ type: 'error', message: n, error: e, object: this }),
                ...
                function cn(e) {
                    rt(this && this.$mobx && mn(this.$mobx), 'Invalid `this`'),
                        rt(!this.$mobx.errorHandler, 'Only one onErrorHandler can be registered'),
                ...
                function yn(e) {
                    return (
                        at('asMap is deprecated, use observable.map or observable.shallowMap instead'), Fe.map(e || {})
                    );
                }
                function _n(e) {
                    return q(
                        function(t, n, r, o, a) {
                            rt(void 0 !== a, U('m009')),
                                rt('function' == typeof a.get, U('m010')),
                                xe(be(t, ''), n, a.get, a.set, e, !1);
                        },
                        function(e) {
                            var t = this.$mobx.values[e];
                            if (void 0 !== t) return t.get();
                ...
                function Cn(e, t, n) {
                    ...
                    if ((void 0 === t && (t = !0), void 0 === n && (n = []), Ce(e))) {
                        if ((t && null === n && (n = []), t && null !== e && 'object' == typeof e))
                            for (var o = 0, a = n.length; o < a; o++) if (n[o][0] === e) return n[o][1];
                        if (I(e)) {
                            var i = r([]),
                                s = e.map(function(e) {
                                    return Cn(e, t, n);
                        ...
                        a = (function(r) {
                            ...
                            return (
                                ...
                                (a.prototype.onBecomeUnobserved = function() {
                                    var e = this.value;
                                    r.prototype.onBecomeUnobserved.call(this),
                    ...
                    return function(e) {
                        ...
                        var t = (function(e) {
                                ...
                                if (null === e || 'object' != typeof e)
                                    throw new Error(
                                        '[mobx] transform expected some kind of object or primitive value, got: ' + e
                                    );
                                var t = e.$transformId;
                ...
                var Pn = {
                        ...
                        interceptReads: function(e, t, n) {
                            ...
                            return void 0 !== r.dehancer
                                ? nt('An intercept reader was already established')
                        ...
                        onReactionError: function(e) {
                            return (
                                Ct.globalReactionErrorHandlers.push(e),
                                function() {
                ...
                'object' == typeof __MOBX_DEVTOOLS_GLOBAL_HOOK__ &&
                    __MOBX_DEVTOOLS_GLOBAL_HOOK__.injectMobx({ spy: y, extras: Pn }),
                    (t.default = Mn);
            }.call(t, n(34));
    },
    function(e, t) {
    ...
    function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            var v,
                g,
                b = { addSuffix: Boolean(d.addSuffix), comparison: p };
            ...
            if (w < 2)
                return d.includeSeconds
                    ? _ < 5
                        ? m('lessThanXSeconds', 5, b)
                        : _ < 10
                        ? m('lessThanXSeconds', 10, b)
                        : _ < 20
                        ? m('lessThanXSeconds', 20, b)
                        : _ < 40
                        ? m('halfAMinute', null, b)
                        : m(_ < 60 ? 'lessThanXMinutes' : 'xMinutes', 1, b)
                    : 0 === w
                    ? m('lessThanXMinutes', 1, b)
                    : m('xMinutes', w, b);
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            if (null == e) return !0;
            if (s(e) && (i(e) || 'string' == typeof e || 'function' == typeof e.splice || u(e) || c(e) || a(e)))
                return !e.length;
            var t = o(e);
                        ...
                        },
                        {
                            ...
                            value: function() {
                                var e = this.props,
                                    ...
                                    E = !(0, s.default)(n.pending),
                                    O = !(0, s.default)(n.skipped),
                                    S = !(0, s.default)(p),
                                    T = !(0, s.default)(m),
                                    C = x ? d.length : 0,
                                    N = w ? n.passes.length : 0,
                                    P = k ? n.failures.length : 0,
                                    M = E ? n.pending.length : 0,
                                    j = O ? n.skipped.length : 0,
                                    D = function(e) {
                                        return (
                                            _ &&
                                            a.default.createElement(l.SuiteList, {
                                                suites: f,
                                                enableChart: r,
                                                enableCode: o,
                                                main: e
                                ...
                                return a.default.createElement(
                                    ...
                                    !L &&
                                        a.default.createElement(
                                            'header',
                                            { className: h('header') },
                                            '' !== g && a.default.createElement('h3', { className: h('title') }, g),
                                            '' !== b && a.default.createElement('h6', { className: h('filename') }, b),
                                            x && r && a.default.createElement(l.SuiteChart, R),
                                            x && a.default.createElement(l.SuiteSummary, I)
                                        ),
                                    a.default.createElement(
                                        'div',
                                        { className: h('body') },
                                        (x || S || T) &&
                                            a.default.createElement(u.TestList, {
                                                uuid: v,
                                                tests: d,
                                                beforeHooks: p,
                                                afterHooks: m,
        ...
        !(function(e) {
                        ...
                        for (var o = n.firstChild; o; o = o.nextSibling)
                            3 === o.nodeType
                                ...
                                : 1 === o.nodeType &&
                                  ...
                                  (r = e(o, r)),
                                  f(o).match(/br|hr|img|input/) || t.push({ event: 'stop', offset: r, node: o }));
                        return r;
                    })(e, 0),
                    t
                );
                    ...
                    if (!a.compiled) {
                        if (((a.compiled = !0), (a.keywords = a.keywords || a.beginKeywords), a.keywords)) {
                            ...
                            'string' == typeof a.keywords
                                ...
                                : n(a.keywords).forEach(function(e) {
                                      u(e, a.keywords[e]);
                                  }),
                                (a.keywords = s);
                        }
            ...
            function g(e, t, n, o) {
                    ...
                    (x +=
                        null != y.subLanguage
                            ? (function() {
                                  ...
                                  var t = e
                                      ? g(y.subLanguage, k, !0, _[y.subLanguage])
                                      : b(k, y.subLanguage.length ? y.subLanguage : void 0);
                                  return (
                                      y.relevance > 0 && (E += t.relevance),
                                      e && (_[y.subLanguage] = t.top),
                            ...
                            : (function() {
                                  ...
                                  for (r = '', t = 0, y.lexemesRe.lastIndex = 0, n = y.lexemesRe.exec(k); n; )
                                      (r += c(k.substring(t, n.index))),
                                          (e = a(y, n)) ? ((E += e[1]), (r += i(e[0], c(n[0])))) : (r += c(n[0])),
                                          (t = y.lexemesRe.lastIndex),
                                          (n = y.lexemesRe.exec(k));
                ...
                function p(e, t) {
                            ...
                            if (d(t.contains[n].beginRe, e))
                                return (
                                    t.contains[n].endSameAsBegin &&
                                        (t.contains[n].endRe = ((o = t.contains[n].beginRe.exec(e)[0]),
                                        new RegExp(o.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'), 'm'))),
                                    t.contains[n]
                                );
                    })(t, y);
                    if (r)
                        return (
                            r.skip
                                ? (k += t)
                                : (r.excludeBegin && (k += t), s(), r.returnBegin || r.excludeBegin || (k = t)),
                            f(r),
                    ...
                    if (o) {
                        ...
                        return (
                            o.starts && (o.endSameAsBegin && (o.starts.endRe = o.endRe), f(o.starts)),
                ...
                var k = '',
                    E = 0;
                try {
                    for (var O, S, T = 0; (y.terminators.lastIndex = T), (O = y.terminators.exec(t)); )
                        (S = p(t.substring(T, O.index), O[0])), (T = O.index + S);
                    ...
                    t
                        ...
                        .forEach(function(t) {
                            ...
                            (n.language = t),
                                ...
                                n.relevance > o.relevance && ((a = o), (o = n));
                        }),
                    a.language && (o.second_best = a),
                    o
                );
            }
            function y(e) {
            ...
            function _(e) {
                var n,
                    ...
                    d = (function(e) {
                        var t,
                            ...
                            o,
                            a = e.className + ' ';
                        if (((a += e.parentNode ? e.parentNode.className : ''), (n = i.exec(a))))
                ...
                p(d) ||
                    ...
                    (a = d ? g(d, u, !0) : b(u)),
                    (r = m(n)).length &&
                        (((s = document.createElementNS('http://www.w3.org/1999/xhtml', 'div')).innerHTML = a.value),
                    ...
                    a.second_best &&
                        (e.second_best = { language: a.second_best.language, re: a.second_best.relevance }));
            }
            function x() {
                if (!x.called) {
                    x.called = !0;
    ...
    function(e, t, n) {
        ...
        var l = document.querySelector('body'),
            ...
            d = new s.default(c, f);
        l.removeAttribute('data-raw'),
            l.removeAttribute('data-config'),
            (window.marge = d),
            o.default.render(
                r.default.createElement(a.MochawesomeReport, { store: d }),
                    ...
                    : null != e &&
                      (N(e) &&
                          (e = (function(e, t) {
                              ...
                              e,
                              o + (!e.key || (t && t.key === e.key) ? '' : ('' + e.key).replace(P, '$&/') + '/') + n
                          )),
                      r.push(e));
        }
    ...
    function(e, t, n) {
        ...
        function M(e) {
            if ((null !== e && (T = O(T, e)), (e = T), (T = null), e && (S(e, C), T && i('95'), l)))
                ...
                extractEvents: function(e, t, n, r) {
                    ...
                    return (
                        ...
                        (e = ge
                            ...
                            ? (((t = pe.getPooled(_e.beforeInput, t, n, r)).data = e), Y(t))
                            : (t = null),
                ...
                e: switch (e.tag) {
                    ...
                    default:
                        ...
                        (n = null),
                            ...
                            (a = ''),
                            o
                                ? (a = ' (at ' + o.fileName.replace(We, '') + ':' + o.lineNumber + ')')
                                : n && (a = ' (created by ' + n + ')'),
                            (n = '\n    in ' + (r || 'Unknown') + a);
                }
                (t += n), (e = e.return);
        ...
        function gt(e, t, n, r) {
            ...
            (null !== o
                ...
                r || null === o
                    ? (function(e) {
                          return (
                              !!ct.call(dt, e) || (!ct.call(ft, e) && (lt.test(e) ? (dt[e] = !0) : ((ft[e] = !0), !1)))
                          );
            ...
            Qt = {
                ...
                extractEvents: function(e, t, n, r) {
                    ...
                    'mouseout' === e || 'mouseover' === e
                        ? ((i = Gt), (s = Kt.mouseLeave), (u = Kt.mouseEnter), (l = 'mouse'))
                        : ('pointerout' !== e && 'pointerover' !== e) ||
                          ((i = Xt), (s = Kt.pointerLeave), (u = Kt.pointerEnter), (l = 'pointer'));
                    var c = null == a ? o : L(a);
                    if (
                        ((o = null == t ? o : L(t)),
                        ((e = i.getPooled(s, a, n, r)).type = l + 'leave'),
                        (e.target = c),
                        (e.relatedTarget = o),
                    ...
                    for (o = t, t = []; a && a !== o && (null === (l = a.alternate) || l !== o); )
                        t.push(a), (a = F(a));
        ...
        function cr(e, t) {
            t &&
                (lr[e] && (null != t.children || null != t.dangerouslySetInnerHTML) && i('137', e, ''),
        ...
        function Lr(e, t, n) {
            ...
            r || i('169'),
                n
                    ? ((t = Ir(e, t, Nr)), (r.__reactInternalMemoizedMergedChildContext = t), Er(Cr), Er(Tr), Or(Tr, t))
                    : Er(Cr),
                Or(Cr, n);
        }
        var zr = null,
        ...
        function oo(e, t) {
            ...
            if (null === n) {
                ...
                (r = e.updateQueue),
                    ...
                    null === r
                        ? null === o
                            ? ((r = e.updateQueue = eo(e.memoizedState)), (o = n.updateQueue = eo(n.memoizedState)))
        ...
        function ao(e, t) {
            var n = e.updateQueue;
            null === (n = null === n ? (e.updateQueue = eo(e.memoizedState)) : io(e, n)).lastCapturedUpdate
        ...
        function so(e, t, n, r, a, i) {
            switch (n.tag) {
                ...
                case 0:
                    if (null === (a = 'function' == typeof (e = n.payload) ? e.call(i, r, a) : e) || void 0 === a)
                        break;
                    return o({}, r, a);
                case 2:
                    Jr = !0;
        ...
        function _o(e, t) {
            return (
                vo !== e &&
                    ...
                    null === mo ? (null === ho && i('293'), (ho.firstContextDependency = mo = t)) : (mo = mo.next = t)),
                e._currentValue
            );
        }
        var xo = {},
        ...
        function Ro(e, t, n) {
            ...
            return (
                'object' == typeof a && null !== a
                    ...
                    : ((o = Mr(t) ? Nr : Tr.current),
                      (a = (r = null !== (r = t.contextTypes) && void 0 !== r) ? Pr(e, o) : Sr)),
                (t = new t(n, a)),
        ...
        function zo(e, t, n, r) {
            ...
            var a = t.contextType;
            'object' == typeof a && null !== a
                ? (o.context = Mo.currentDispatcher.readContext(a))
                : ((a = Mr(t) ? Nr : Tr.current), (o.context = Pr(e, a))),
                null !== (a = e.updateQueue) && (uo(e, a, n, o, r), (o.state = e.memoizedState)),
                'function' == typeof (a = t.getDerivedStateFromProps) && (Do(e, t, a, n), (o.state = e.memoizedState)),
        ...
        function Ho(e) {
            ...
            function l(e, t, n, r) {
                return null !== t && t.elementType === n.type
                    ...
                    : (((r = Yr(n.type, n.key, n.props, null, e.mode, r)).ref = Uo(e, t, n)), (r.return = e), r);
            }
            function c(e, t, n, r) {
                return null === t ||
                    4 !== t.tag ||
            ...
            function d(e, t, n) {
                ...
                if ('object' == typeof t && null !== t) {
                    switch (t.$$typeof) {
                        case qe:
                            return (
                                ((n = Yr(t.type, t.key, t.props, null, e.mode, n)).ref = Uo(e, null, t)),
                                (n.return = e),
                                n
                            );
                        case Ge:
                    ...
                    switch (r.$$typeof) {
                        case qe:
                            return (
                                ...
                                r.type === Xe ? f(t, e, r.props.children, o, r.key) : l(t, e, r, o)
                            );
                        case Ge:
            ...
            function m(o, i, s, u) {
                ...
                if (null === f) {
                    for (; m < s.length; m++)
                        (f = d(o, s[m], u)) && ((i = a(f, i, m)), null === c ? (l = f) : (c.sibling = f), (c = f));
                    return l;
                }
            ...
            function v(o, s, u, l) {
                ...
                for (
                    var f = (c = null), m = s, v = (s = 0), g = null, b = u.next();
                    null !== m && !b.done;
                    v++, b = u.next()
                ) {
                ...
                if (null === m) {
                    for (; !b.done; v++, b = u.next())
                        null !== (b = d(o, b.value, l)) &&
                            ((s = a(b, s, v)), null === f ? (c = b) : (f.sibling = b), (f = b));
                    return c;
                }
                        ...
                        case qe:
                            e: {
                                for (c = a.key, l = r; null !== l; ) {
                                    if (l.key === c) {
                                        if (7 === l.tag ? a.type === Xe : l.elementType === a.type) {
                                            n(e, l.sibling),
                                                ((r = o(l, a.type === Xe ? a.props.children : a.props)).ref = Uo(
                                                    e,
                                                    l,
                                                    a
                                                )),
                                ...
                                a.type === Xe
                                    ...
                                    : (((u = Yr(a.type, a.key, a.props, null, e.mode, u)).ref = Uo(e, r, a)),
                                      (u.return = e),
                                      (e = u));
                            }
                            return s(e);
        ...
        function ra(e, t, n, r, o, a) {
            if (null === e) {
                ...
                return 'function' != typeof i ||
                    ...
                    ? (((e = Yr(n.type, null, r, null, t.mode, a)).ref = t.ref), (e.return = t), (t.child = e))
                    : ((t.tag = 15), (t.type = i), oa(e, t, i, r, o, a));
            }
            return (
                (i = e.child),
                o < a && ((o = i.memoizedProps), (n = null !== (n = n.compare) ? n : en)(o, r) && e.ref === t.ref)
                    ? fa(e, t, a)
                    : ((t.effectTag |= 1), ((e = Vr(i, r)).ref = t.ref), (e.return = t), (t.child = e))
            );
        }
        ...
        function sa(e, t, n, r, o) {
            ...
            if ((yo(t), null === t.stateNode))
                ...
                u = i.state = d;
                var p = t.updateQueue;
                null !== p && (uo(t, p, r, i, o), (u = t.memoizedState)),
                    s !== r || d !== u || Cr.current || Jr
                        ? ('function' == typeof c && (Do(t, n, c, r), (u = t.memoizedState)),
                          (s = Jr || Io(t, n, s, r, d, u, l))
                              ? (f ||
                ...
                (i = t.stateNode),
                    (s = t.memoizedProps),
                    (i.props = t.type === t.elementType ? s : Po(t.type, s)),
                    (u = i.context),
                    ...
                    (u = t.memoizedState),
                    (d = i.state = u),
                    null !== (p = t.updateQueue) && (uo(t, p, r, i, o), (d = t.memoizedState)),
                    s !== r || u !== d || Cr.current || Jr
                        ? ('function' == typeof c && (Do(t, n, c, r), (d = t.memoizedState)),
                          (c = Jr || Io(t, n, s, r, u, d, l))
                              ? (f ||
        ...
        function ua(e, t, n, r, o, a) {
            ...
            return (
                (t.effectTag |= 1),
                null !== e && i ? ((t.child = Vo(t, e.child, null, a)), (t.child = Vo(t, null, s, a))) : ta(e, t, s, a),
            ...
            if (null === e)
                ...
                null !== e.memoizedState
                    ? ((s = (r = e.child).sibling),
                      i
                          ? ((n = o.fallback),
                            ...
                            0 == (1 & t.mode) &&
                                ((i = null !== t.memoizedState ? t.child.child : t.child) !== r.child && (o.child = i)),
                    ...
                    : ((s = e.child),
                      i
                          ? ((i = o.fallback),
                            ((o = Wr(null, r, 0, null)).child = s),
                            0 == (1 & t.mode) && (o.child = null !== t.memoizedState ? t.child.child : t.child),
                            ((r = o.sibling = Wr(i, r, n, null)).effectTag |= 2),
                            (n = o),
                            (o.childExpirationTime = 0),
                            (n.return = r.return = t))
        ...
        function fa(e, t, n) {
            ...
            if ((null !== e && t.child !== e.child && i('153'), null !== t.child)) {
                for (
                    n = Vr((e = t.child), e.pendingProps, e.expirationTime), t.child = n, n.return = t;
                    null !== e.sibling;

                )
                    (e = e.sibling), ((n = n.sibling = Vr(e, e.pendingProps, e.expirationTime)).return = t);
                n.sibling = null;
            }
            return t.child;
        }
            ...
            switch (((t.expirationTime = 0), t.tag)) {
                        ...
                        (r = t.memoizedState.element) === o
                            ...
                            : ((o = t.stateNode),
                              (o = (null === e || null === e.child) && o.hydrate) &&
                                  (($o = xr(t.stateNode.containerInfo)), (Wo = t), (o = qo = !0)),
                              o ? ((t.effectTag |= 2), (t.child = Yo(t, null, r, n))) : (ta(e, t, r, n), Jo()),
                              (t = t.child)),
                        t
                    );
                case 5:
                    return (
                        ...
                        (s = o.children),
                        gr(r, o) ? (s = null) : null !== a && gr(r, a) && (t.effectTag |= 16),
                        aa(e, t),
                ...
                case 4:
                    return (
                        So(t, t.stateNode.containerInfo),
                        (r = t.pendingProps),
                        null === e ? (t.child = Vo(t, null, r, n)) : ta(e, t, r, n),
                        t.child
                    );
                case 11:
                ...
                case 9:
                    return (
                        ...
                        yo(t),
                        (r = r((o = _o(o, a.unstable_observedBits)))),
                        (t.effectTag |= 1),
                        ta(e, t, r, n),
                        t.child
                    );
        ...
        function xa(e) {
            switch (('function' == typeof Fr && Fr(e), e.tag)) {
                ...
                case 15:
                    ...
                    break;
                case 1:
                    if ((_a(e), 'function' == typeof (t = e.stateNode).componentWillUnmount))
                        try {
                ...
                if (5 === o.tag || 6 === o.tag)
                    if (n)
                        ...
                        r
                            ? ((s = t),
                              (u = o.stateNode),
                              8 === s.nodeType ? (a = s.parentNode).insertBefore(u, s) : (a = s).appendChild(u),
            ...
            switch (t.tag) {
                ...
                case 13:
                    if (
                        ...
                        (r = void 0),
                        (e = t),
                        null === n ? (r = !1) : ((r = !0), (e = t.child), 0 === n.timedOutAt && (n.timedOutAt = Oi())),
                        null !== e &&
                            (function(e, t) {
                                for (var n = e; ; ) {
                                    if (5 === n.tag) {
                        ...
                        t.updateQueue = null;
                        var s = t.stateNode;
                        null === s && (s = t.stateNode = new ba()),
                            n.forEach(function(e) {
                                var n = function(e, t) {
                                    var n = e.stateNode;
                                    null !== n && n.delete(t),
                                        (t = Qa((t = Oi()), e)),
                                        null !== (e = Ja(e, t)) && (Xr(e, t), 0 !== (t = e.expirationTime) && Si(e, t));
                                }.bind(null, t, e);
        ...
        var Pa = { readContext: _o },
            Ma = Ye.ReactCurrentOwner,
            ja = 1073741822,
            Da = 0,
            Aa = !1,
            Ia = null,
                        ...
                        switch (t.tag) {
                            ...
                            case 3:
                                To(),
                                    ...
                                    (null !== a && null !== a.child) || (Zo(t), (t.effectTag &= -3)),
                                    ma(t);
                                break;
                            case 5:
                                No(t);
                                ...
                                if (((s = t.type), null !== a && null != t.stateNode))
                                    va(a, t, s, u, l), a.ref !== t.ref && (t.effectTag |= 128);
                                else if (u) {
                                    var c = Oo(wo.current);
                                    if (Zo(t)) {
                                        a = (u = t).stateNode;
                                                ...
                                                'children' === s
                                                    ? 'string' == typeof c
                                                        ...
                                                        : 'number' == typeof c &&
                                                          a.textContent !== '' + c &&
                                                          (f = ['children', '' + c])
                                                    : y.hasOwnProperty(s) && null != c && dr(p, s));
                                        switch (l) {
                                            case 'input':
                                                He(a), kt(a, d, !0);
                                                break;
                                        ...
                                        for (c in b)
                                            if (b.hasOwnProperty(c)) {
                                                ...
                                                'style' === c
                                                    ...
                                                    ? null != (_ = _ ? _.__html : void 0) && rr(g, _)
                                                    : 'children' === c
                                                    ? 'string' == typeof _
                                                        ? ('textarea' !== v || '' !== _) && or(g, _)
                                            ...
                                            case 'select':
                                                ((l = p).multiple = !!d.multiple),
                                                    null != (p = d.value)
                                                        ? qn(l, !!d.multiple, p, !1)
                                                        : null != d.defaultValue &&
                                                          qn(l, !!d.multiple, d.defaultValue, !0);
                                                break;
                                            default:
                                    ...
                                    : ('string' != typeof u && (null === t.stateNode && i('166')),
                                      ...
                                      Zo(t)
                                          ? ((s = (u = t).stateNode),
                                            (a = u.memoizedProps),
                                            (s[D] = u),
                                            (u = s.nodeValue !== a) && pa(t))
                                          : ((s = t),
                                            ((u = (9 === a.nodeType ? a : a.ownerDocument).createTextNode(u))[D] = t),
                                            (s.stateNode = u)));
                                break;
                            case 11:
                                break;
                                ...
                                (u = null !== u),
                                    ...
                                    null !== a &&
                                        ...
                                        (null !== (a = a.child.sibling) &&
                                            ...
                                            (a.effectTag = 8))),
                                    (u !== s || (0 == (1 & t.effectTag) && u)) && (t.effectTag |= 4);
                                break;
                            case 7:
                            case 8:
                            case 12:
        ...
        function Xa(e, t) {
            ...
            (n === La && e === Ra && null !== Ia) ||
                (Wa(), (La = n), (Ia = Vr((Ra = e).current, null)), (e.pendingCommitExpirationTime = 0));
            for (var r = !1; ; ) {
                try {
                    if (t) for (; null !== Ia && !Ni(); ) Ia = Ga(Ia);
                    else for (; null !== Ia; ) Ia = Ga(Ia);
                } catch (t) {
                    if (((vo = mo = ho = null), null === Ia)) (r = !0), Ii(t);
                    else {
                        null === Ia && i('271');
                        var o = Ia,
                            a = o.return;
                                            ...
                                            if (
                                                ...
                                                (c.effectTag |= 64),
                                                    ...
                                                    1 === l.tag &&
                                                        (null === l.alternate
                                                            ? (l.tag = 17)
                                                            : (((a = no(1073741823)).tag = 2), oo(l, a))),
                                                    (l.expirationTime = 1073741823);
                                                break e;
                                            }
                                            null === (l = s.pingCache)
                                                ? ((l = s.pingCache = new Sa()), (u = new Set()), l.set(f, u))
                                                : void 0 === (u = l.get(f)) && ((u = new Set()), l.set(f, u)),
                                                u.has(a) || (u.add(a), (l = Za.bind(null, s, f, a)), f.then(l, l)),
                                                -1 === d
                                                    ? (s = 1073741823)
                                                    : (-1 === p && (p = 10 * (1073741822 - Qr(s, a)) - 5e3),
                                                      (s = p + d)),
                                                0 <= s && za < s && (za = s),
                                                (c.effectTag |= 2048),
                                                (c.expirationTime = a);
            ...
            if (((Aa = !1), (vo = mo = ho = Ma.currentDispatcher = null), r)) (Ra = null), (e.finishedWork = null);
                ...
                if ((null === (r = e.current.alternate) && i('281'), (Ra = null), Fa)) {
                    if (
                        ...
                        (0 !== o && o < n) || (0 !== a && a < n) || (0 !== s && s < n))
                    )
                        return Kr(e, n), void Ei(e, r, n, e.expirationTime, -1);
                    if (!e.didError && t)
                        return (
                            (e.didError = !0),
                ...
                t && -1 !== za
                    ? (Kr(e, n),
                      (t = 10 * (1073741822 - Qr(e, n))) < za && (za = t),
                      (t = 10 * (1073741822 - Oi())),
                      (t = za - t),
                ...
                switch (n.tag) {
                    case 1:
                        ...
                        if (
                            ...
                            ('function' == typeof r.componentDidCatch && (null === Ya || !Ya.has(r)))
                        )
                            return oo(n, (e = Ca(n, (e = fo(t, e)), 1073741823))), void ei(n, 1073741823);
                        break;
                    case 3:
        ...
        function ei(e, t) {
            null !== (e = Ja(e, t)) &&
                (!Aa && 0 !== La && t > La && Wa(),
                Xr(e, t),
                (Aa && !Ba && Ra === e) || Si(e, e.expirationTime),
                _i > yi && ((_i = 0), i('185')));
        }
        ...
        function ki(e, t) {
            ...
            (oi = t),
                (e = a.unstable_now() - vi),
                (ai = a.unstable_scheduleCallback(Pi, { timeout: 10 * (1073741822 - t) - e }));
        }
        ...
        function Si(e, t) {
            null === e.nextScheduledRoot
                ...
                ii ||
                    (di
                        ? pi && ((si = e), (ui = 1073741823), Di(e, 1073741823, !1))
                        : 1073741823 === t
                        ? Mi(1073741823, !1)
                        : ki(e, t));
        }
            ...
            if (null !== ri)
                for (var n = ri, r = ni; null !== r; ) {
                    ...
                    if (0 === o) {
                        ...
                        if (r === ni)
                            (ni = o = r.nextScheduledRoot), (ri.nextScheduledRoot = o), (r.nextScheduledRoot = null);
                        else {
                            if (r === ri) {
        ...
        function Mi(e, t) {
            if ((Ti(), t))
                for (wi(), bi = gi; null !== si && 0 !== ui && e <= ui && !(Ci && gi > ui); )
                    Di(si, ui, gi > ui), Ti(), wi(), (bi = gi);
            else for (; null !== si && 0 !== ui && e <= ui; ) Di(si, ui, !1), Ti();
            if ((t && ((oi = 0), (ai = null)), 0 !== ui && ki(si, ui), (_i = 0), (xi = null), null !== mi))
            ...
            if ((ii && i('245'), (ii = !0), n)) {
                ...
                null !== r
                    ...
                    : ((e.finishedWork = null),
                      ...
                      Xa(e, n),
                      null !== (r = e.finishedWork) && (Ni() ? (e.finishedWork = r) : Ai(e, r, t)));
            } else
                null !== (r = e.finishedWork)
                    ...
                    : ((e.finishedWork = null),
                      -1 !== (r = e.timeoutHandle) && ((e.timeoutHandle = -1), yr(r)),
                      Xa(e, n),
                      null !== (r = e.finishedWork) && Ai(e, r, t));
            ii = !1;
        }
        function Ai(e, t, n) {
            var r = e.firstBatch;
            ...
            if (
                ...
                if ('selectionStart' in o) var a = { start: o.selectionStart, end: o.selectionEnd };
                    ...
                    e: {
                        var s =
                            (a = ((a = o.ownerDocument) && a.defaultView) || window).getSelection && a.getSelection();
                        if (s && 0 !== s.rangeCount) {
                            a = s.anchorNode;
                                        ...
                                        if (256 & u.effectTag && null !== b) {
                                            var y = b.memoizedProps,
                                                ...
                                                w = x.getSnapshotBeforeUpdate(
                                                    u.elementType === u.type ? y : Po(u.type, y),
                                                    _
                                                );
            ...
            if (
                ...
                null !== b &&
                    ...
                    void 0 === (O = b.end) && (O = E),
                    'selectionStart' in k
                        ? ((k.selectionStart = E), (k.selectionEnd = Math.min(O, k.value.length)))
                        : (O = ((E = k.ownerDocument || document) && E.defaultView) || window).getSelection &&
                          ((O = O.getSelection()),
                          (y = k.textContent.length),
                          (S = Math.min(b.start, y)),
                          (b = void 0 === b.end ? S : Math.min(b.end, y)),
                          !O.extend && S > b && ((y = b), (b = S), (S = y)),
                          (y = In(k, S)),
                          (_ = In(k, b)),
                          y &&
                              _ &&
                              ...
                              ((E = E.createRange()).setStart(y.node, y.offset),
                              O.removeAllRanges(),
                              S > b
                                  ? (O.addRange(E), O.extend(_.node, _.offset))
                                  : (E.setEnd(_.node, _.offset), O.addRange(E))))),
                    (E = []);
                for (O = k; (O = O.parentNode); )
                    1 === O.nodeType && E.push({ element: O, left: O.scrollLeft, top: O.scrollTop });
                for ('function' == typeof k.focus && k.focus(), k = 0; k < E.length; k++)
                    ((O = E[k]).element.scrollLeft = O.left), (O.element.scrollTop = O.top);
            }
            ...
            (Aa = Ba = !1),
                ...
                (T = t.expirationTime),
                0 === (t = (t = t.childExpirationTime) > T ? t : T) && (Ya = null),
                (e.expirationTime = t),
                (e.finishedWork = null);
        }
        function Ii(e) {
    ...
    function(e, t, n) {
                        ...
                        (r._renderMenu = function(e, t) {
                            var n,
                                ...
                                k = h(
                                    'list-item',
                                    m,
                                    ((n = { 'link-item': !e.items, selected: f && _ }),
                                    (o = d),
                                    (i = f && _ && d),
                                    o in n
                                ...
                                E = h('list-item-text'),
                                O = h('list-item-link', p);
                            return a.default.createElement(
                                'li',
                                { key: t, className: k },
                                b
                                    ? a.default.createElement('span', { className: E }, y)
                                    : v
                                    ? v(e, y, g)
                                    : a.default.createElement('a', { className: O, href: '', onClick: x }, y),
                                b && a.default.createElement('ul', { className: w }, b.map(r._renderMenu))
                            );
                        }),
                        p(r, n)
                    );
                    ...
                    r(t, [
                        {
                            ...
                            value: function() {
                                var e = this.props,
                                    ...
                                    i = e.menuAlign,
                                    s = e.open,
                                    u = h('list', 'list-main', t, 'align-' + i, { open: s, close: !1 === s });
                                return a.default.createElement(
                                    'ul',
                                    { className: u, style: r, ref: n },
                                    !!o && o.map(this._renderMenu)
                                );
                            }
                        }
                    ]),
        ...
        (m.propTypes = {
            ...
            (m.defaultProps = { menuAlign: 'left', showSelected: !1, itemTitleProp: 'title' }),
    ...
    function(e, t, n) {
        ...
        var l = i.default.bind(s.default),
            c = function() {
                return r.default.createElement(a.Icon, {
        ...
        function f(e) {
            ...
            return r.default.createElement(
                'div',
                { className: l('component', t) },
                !!i && r.default.createElement(a.Icon, { name: i, className: l('icon', s) }),
                !!o && r.default.createElement('span', { className: v }, o),
                r.default.createElement(a.Dropdown, {
        ...
        (f.propTypes = {
            ...
            (f.displayName = 'DropdownSelector'),
            (t.default = f);
    },
    function(e, t) {
        e.exports = {
                        ...
                        value: function() {
                            ...
                            return o
                                ? s.default.createElement(
                                      'span',
                                      null,
                                      s.default.createElement('span', { className: (0, l.default)(t) }, i),
                                      s.default.createElement('span', { className: (0, l.default)(n) }, u)
                                  )
                                : s.default.createElement(
                                      'span',
                ...
                return r.default.createElement(
                    ...
                    r.default.createElement(
                        ...
                        r.default.createElement(
                            ...
                            r.default.createElement(
                                'a',
                                { href: c, target: '_blank', rel: 'noopener noreferrer' },
                                'Adam Gruber'
                            ),
                            ' • ',
                            r.default.createElement('span', null, 'v', t)
                        )
                    )
                );
            };
                ...
                (0, c.inject)('reportStore')(
                    (r =
                        (0, c.observer)(
                                                ...
                                                return (
                                                    ...
                                                    u.default.createElement(
                                                        ...
                                                        u.default.createElement(
                                                            'div',
                                                            { className: h('wrap') },
                                                            u.default.createElement('div', { className: h('spinner') }),
                                                            u.default.createElement(
                                                                'h4',
                                                                { className: h('text') },
                                                                'Generating Report'
                            ...
                            (o.propTypes = { reportStore: l.default.object }),
                            (r = a))
                        ) || r)
                ) || r;
        t.default = m;
        ...
        var c = (0, a.observer)(function(e) {
            ...
            return r.default.createElement(
                ...
                r.default.createElement(
                    'main',
                    null,
                    r.default.createElement(i.Navbar, { onMenuClick: n, reportTitle: o, stats: l }),
                    r.default.createElement(i.ReportBody, null),
                    r.default.createElement(i.Loader, null),
                    r.default.createElement(i.Footer, { version: f }),
                    r.default.createElement(s.NavMenu, null),
                    c && r.default.createElement(u.default, { position: { bottom: 0, right: 20 } })
                )
            );
        });
                                            ...
                                            value: function() {
                                                ...
                                                return l.default.createElement(
                                                    ...
                                                    l.default.createElement(
                                                        ...
                                                        l.default.createElement(
                                                            'button',
                                                            { onClick: n, className: y('close-btn') },
                                                            l.default.createElement(h.Icon, { name: 'close' })
                                                        ),
                                                        l.default.createElement(
                                                            'div',
                                                            { className: y('section') },
                                                            l.default.createElement('h3', { className: y('title') }, r),
                                                            l.default.createElement(
                                                                'h6',
                                                                { className: y('date') },
                                                                (0, d.format)(b.end, 'dddd, MMMM D, YYYY h:mma')
                                                            )
                                                        ),
                                                        l.default.createElement(
                                                            'div',
    ...
    function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            var h,
                m,
                v,
                g = { addSuffix: Boolean(c.addSuffix), comparison: f };
    ...
    function(e, t, n) {
        ...
        e.exports = function(e, t, n) {
            ...
            o &&
                o.format &&
                o.format.formatters &&
                ((a = o.format.formatters), o.format.formattingTokensRegExp && (c = o.format.formattingTokensRegExp));
            var f = i(e);
            return s(f)
                ? (function(e, t, n) {
                      var r,
                                    ...
                                    u.default.createElement(
                                        ...
                                        t.map(function(e) {
                                            return u.default.createElement(
                                                'ul',
                                                { key: e.uuid, className: m('list', 'sub') },
                            ...
                            value: function() {
                                ...
                                return u.default.createElement(
                                    ...
                                    u.default.createElement(
                                        ...
                                        O && ((t = 'pause'), (n = 'pending')),
                                        E && ((t = 'close'), (n = 'fail')),
                                        u.default.createElement(d.Icon, {
                                            name: t,
                                            className: g('link-icon', n),
                                            size: 18
                                        })),
                                        u.default.createElement('span', null, '' === v ? m : v)
                                    ),
                                    h && !!h.length && u.default.createElement(p.NavMenuList, a({ suites: h }, b))
                                );
                            }
                        }
                    ]),
    ...
    function(e, t, n) {
        ...
        var l = i.default.bind(s.default),
            c = function(e) {
                ...
                return r.default.createElement(
                    'div',
                    { className: l('component', 'z-depth-1'), role: 'navigation' },
                    r.default.createElement(
                        'div',
                        { className: l('report-info-cnt') },
                        r.default.createElement(
                            'button',
                            { onClick: t, className: l('menu-button', 'open-menu') },
                            r.default.createElement(a.Icon, { name: 'menu' })
                        ),
                        r.default.createElement('h1', { className: l('report-title'), title: n }, n)
                    ),
                    r.default.createElement(
                        'div',
                        { className: l('stats') },
                        r.default.createElement(a.QuickSummary, { stats: o })
                    ),
                    f &&
                        r.default.createElement(
                            'div',
        ...
        (c.propTypes = { onMenuClick: o.default.func, reportTitle: o.default.string, stats: o.default.object }),
            ...
            c = function(e) {
                ...
                return r.default.createElement(
                    ...
                    r.default.createElement(
                        ...
                        r.default.createElement(
                            'li',
                            { className: l('item', 'duration'), title: 'Duration' },
                            r.default.createElement(a.Icon, { name: 'timer', className: l('icon') }),
                        ...
                        r.default.createElement(
                            'li',
                            { className: l('item', 'suites'), title: 'Suites' },
                            r.default.createElement(a.Icon, { name: 'library_books', className: l('icon') }),
                            o
                        ),
                        r.default.createElement(
                            'li',
                            { className: l('item', 'tests'), title: 'Tests' },
                            r.default.createElement(a.Icon, { name: 'assignment', className: l('icon') }),
                            i
                        )
                    ),
                    r.default.createElement(
                        ...
                        r.default.createElement(
                            'li',
                            { className: l('item', 'passes'), title: 'Passed' },
                            r.default.createElement(a.Icon, { name: 'check', className: l('icon', 'circle-icon') }),
                            s
                        ),
                        r.default.createElement(
                            'li',
                            { className: l('item', 'failures'), title: 'Failed' },
                            r.default.createElement(a.Icon, { name: 'close', className: l('icon', 'circle-icon') }),
                            u
                        ),
                        !!c &&
                            r.default.createElement(
                                'li',
                                { className: l('item', 'pending'), title: 'Pending' },
                                r.default.createElement(a.Icon, { name: 'pause', className: l('icon', 'circle-icon') }),
                                c
                            ),
                        !!f &&
                            r.default.createElement(
                                'li',
                                { className: l('item', 'skipped'), title: 'Skipped' },
                                r.default.createElement(a.Icon, { name: 'stop', className: l('icon', 'circle-icon') }),
                                f
                            )
                    )
                );
    ...
    function(e, t, n) {
        ...
        function c(e) {
            var t = e.active,
                ...
                u = e.iconClassName,
                c = e.onClick,
                f = l('label', { 'with-icon': !!s }, o);
            return r.default.createElement(
                'div',
                { className: l('component', n) },
                !!s && r.default.createElement(a.Icon, { name: s, className: u }),
                !!i && r.default.createElement('span', { className: f }, i),
                r.default.createElement(
                    'div',
                    { className: l('outer', { off: !t }), onClick: c },
            ...
            (0, c.inject)('reportStore')(
                (r =
                    (0, c.observer)(
                                ...
                                i(t, [
                                    ...
                                    },
                                    {
                                        ...
                                        value: function() {
                                            ...
                                            return s.default.createElement(
                                                'div',
                                                { id: 'details', className: (0, d.default)('details', 'container') },
                                                r.map(function(e) {
                                                    return s.default.createElement(f.Suite, {
                                                        key: e.uuid,
                                                        suite: e,
                                                        enableChart: n,
                                                        enableCode: t
                        ...
                        (o.propTypes = { reportStore: u.default.object }),
                        (r = a))
                    ) || r)
            ) || r;
        t.default = h;
    ...
    function(e, t, n) {
        ...
        var h = f.default.bind(d.default),
                    ...
                    a(t, [
                        {
                            ...
                            value: function() {
                                var e = this.props,
                                    t = e.test;
                                ((e.enableCode && t.pass) || t.context || t.fail || t.isHook) &&
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return s.default.createElement(
                                    ...
                                    s.default.createElement(
                                        'header',
                                        { className: h('header'), onClick: this.toggleExpandedState },
                                        ((e = void 0),
                                        (t = void 0),
                                        d && ((e = 'check'), (t = 'pass')),
                                        p && ((e = 'close'), (t = 'fail')),
                                        ...
                                        g &&
                                            ((e = p
                                                ...
                                                : 'rotate_right'),
                                            (t = 'hook')),
                                        s.default.createElement(l.Icon, {
                                            name: e,
                                            className: h('icon', t),
                                            size: g ? 24 : 18
                                        })),
                                        s.default.createElement('h4', { className: h('title'), title: i }, i),
                                        s.default.createElement(
                                            'div',
                                            { className: h('info') },
                                            !!_ &&
                                            ...
                                            !g &&
                                                s.default.createElement(l.Duration, {
                                    ...
                                    !!b.message &&
                                        s.default.createElement('p', { className: h('error-message') }, b.message),
                                    this.state.expanded &&
                                        s.default.createElement(
                                            'div',
                                            { className: h('body') },
            ...
            (r.propTypes = { test: u.default.object, enableCode: u.default.bool }),
            (r.defaultProps = { enableCode: !0 }),
            o);
        t.default = m;
    },
    function(e, t, n) {
        ...
        var v = d.default.bind(p.default),
                            ...
                            value: function() {
                                ...
                                return (
                                    ...
                                    s.default.createElement(
                                            ...
                                            f
                                                ? o.map(function(e, t) {
                                                      ...
                                                      return n
                                                          ? s.default.createElement(
                                                                'span',
                                                                { key: t, className: v('code-diff-expected') },
                                                                o
                                                            )
                                                          : r
                                                          ? s.default.createElement(
                                                                'span',
                                                                { key: t, className: v('code-diff-actual') },
                                                                o
                                                            )
                                                          : o;
                                                  })
                                        ...
                                        !!i && u && s.default.createElement('span', { className: v('code-label') }, i)
                                    )
                                );
                            }
                        }
            ...
            (r.defaultProps = { lang: 'javascript', highlight: !0, showLabel: !1 }),
            o);
        t.default = g;
    },
    function(e, t, n) {
            ...
            x = ((o = r = (function(e) {
                function t() {
                    ...
                    return (
                        ...
                        (r.renderVideo = function(e, t) {
                            var n = y.test(e),
                                r = b.test(e),
                                o = n && !r ? 'http://' + e : e;
                            return s.default.createElement(
                                'video',
                                { controls: !0, src: o, className: m('video') },
                                s.default.createElement('track', { kind: 'captions' }),
                                t,
                                s.default.createElement(
                                    'a',
                                    {
                        ...
                        (r.renderImage = function(e, t) {
                            ...
                            return s.default.createElement(
                                'a',
                                { href: o, className: m('image-link'), rel: 'noopener noreferrer', target: '_blank' },
                        ...
                        (r.renderContextContent = function(e, t) {
                            ...
                            if ((0, c.default)(e))
                                return s.default.createElement(l.CodeSnippet, {
                        ...
                        (r.renderContext = function(e, t) {
                            ...
                            if ((void 0 !== t && (n.key = t), (0, c.default)(e)))
                                return s.default.createElement('div', n, r.renderContextContent(e));
                            var o = e.title,
                                a = e.value;
                            return s.default.createElement(
                                'div',
                                n,
                                s.default.createElement('h4', { className: m('context-item-title') }, o, ':'),
                                r.renderContextContent(a, o, !0)
                            );
                        }),
                        h(r, n)
                    );
                    ...
                    a(t, [
                        {
                            ...
                            value: function() {
                                ...
                                return s.default.createElement(
                                    'div',
                                    { className: m(t, 'context') },
                                    s.default.createElement(
                                        'h4',
                                        { className: m('context-title') },
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return s.default.createElement('div', {
                                    className: h('chart-wrap', 'ct-chart'),
                                    ref: function(t) {
                                        e.node = t;
                                    }
                                });
                        ...
                        (n.namespaces = {
                            ...
                            (n.extend = function(e) {
                                ...
                                for (e = e || {}, t = 1; t < arguments.length; t++)
                                    for (var a in (r = arguments[t]))
                                        'object' != typeof (o = r[a]) || null === o || o instanceof Array
                                            ? (e[a] = o)
                                            : (e[a] = n.extend(e[a], o));
                                return e;
                            }),
                            ...
                            (n.normalizeData = function(e, t, r) {
                                var o,
                                    a = { raw: e, normalized: {} };
                                return (
                                    (a.normalized.series = n.getDataArray({ series: e.series || [] }, t, r)),
                                    (o = a.normalized.series.every(function(e) {
                                    ...
                                    Array.prototype.push.apply(
                                        a.normalized.labels,
                                        n.times(Math.max(0, o - a.normalized.labels.length)).map(function() {
                                            return '';
                                        })
                                    ),
                                    t && n.reverseData(a.normalized),
                                    a
                                );
                            }),
                                    ...
                                    if (!n.isDataHoleValue(t)) {
                                        if (r) {
                                            ...
                                            return (
                                                ...
                                                (o.x = t.hasOwnProperty('x') ? n.getNumberOrUndefined(t.x) : o.x),
                                                (o.y = t.hasOwnProperty('y') ? n.getNumberOrUndefined(t.y) : o.y),
                                                o
                                            );
                                        }
                                ...
                                return (
                                    o
                                        ? ('start' === t.axisX.position
                                              ? ((c.y2 = l.top + i), (c.y1 = Math.max(u - l.bottom, c.y2 + 1)))
                                              : ((c.y2 = l.top), (c.y1 = Math.max(u - l.bottom - i, c.y2 + 1))),
                                          'start' === t.axisY.position
                                              ? ((c.x1 = l.left + a), (c.x2 = Math.max(s - l.right, c.x1 + 1)))
                                              : ((c.x1 = l.left), (c.x2 = Math.max(s - l.right - a, c.x1 + 1))))
                                        : ((c.x1 = l.left),
                            ...
                            (n.createLabel = function(e, r, o, a, i, s, u, l, c, f, d) {
                                var p,
                                    h = {};
                                if (
                                    ((h[i.units.pos] = e + u[i.units.pos]),
                                    (h[i.counterUnits.pos] = u[i.counterUnits.pos]),
                                    (h[i.units.len] = r),
                                    (h[i.counterUnits.len] = Math.max(0, s - 10)),
                                    f)
                                ) {
                                    ...
                                    (m.className = c.join(' ')),
                                        ...
                                        (m.innerText = a[o]),
                                        (m.style[i.units.len] = Math.round(h[i.units.len]) + 'px'),
                                        (m.style[i.counterUnits.len] = Math.round(h[i.counterUnits.len]) + 'px'),
                                        (p = l.foreignObject(m, n.extend({ style: 'overflow: visible;' }, h)));
                                } else p = l.elem('text', h, c.join(' ')).text(a[o]);
                                d.emit(
                                    'draw',
                                    n.extend({ type: 'label', axis: i, index: o, group: l, element: p, text: a[o] }, h)
                                );
                            }),
                            ...
                            (n.splitIntoSegments = function(e, t, r) {
                                ...
                                for (var o = [], a = !0, i = 0; i < e.length; i += 2)
                                    void 0 === n.getMultiValue(t[i / 2].value)
                                        ? r.fillHoles || (a = !0)
                                        : (r.increasingX && i >= 2 && e[i] <= e[i - 2] && (a = !0),
                                          a && (o.push({ pathCoordinates: [], valueData: [] }), (a = !1)),
                                          o[o.length - 1].pathCoordinates.push(e[i], e[i + 1]),
                                          o[o.length - 1].valueData.push(t[i / 2]));
                                return o;
                            });
                    })(window, document, e),
                    (function(e, t, n) {
                                    ...
                                    function(t, r) {
                                        for (var o = new n.Svg.Path(), a = !0, i = 0; i < t.length; i += 2) {
                                            ...
                                            void 0 !== n.getMultiValue(l.value)
                                                ? (a ? o.move(s, u, !1, l) : o.line(s, u, !1, l), (a = !1))
                                                : e.fillHoles || (a = !0);
                                        }
                                        return o;
                                    }
                                ...
                                return function(r, o) {
                                    for (var a, i, s, u = new n.Svg.Path(), l = 0; l < r.length; l += 2) {
                                        ...
                                        void 0 !== p.value
                                            ? (void 0 === s
                                                  ? u.move(c, f, !1, p)
                                                  : u.curve(a + d, i, c - d, f, c, f, !1, p),
                                              (a = c),
                                              (i = f),
                                              (s = p))
                                            : e.fillHoles || (a = c = s = void 0);
                                    }
                                    return u;
                                };
                            }),
                            (n.Interpolation.cardinal = function(e) {
                                ...
                                return function o(a, i) {
                                    ...
                                    if (s.length) {
                                        ...
                                        if (((a = s[0].pathCoordinates), (i = s[0].valueData), a.length <= 4))
                                            return n.Interpolation.none()(a, i);
                                        for (
                                            var l = new n.Svg.Path().move(a[0], a[1], !1, i[0]), c = 0, f = a.length;
                                            f - 2 > c;
                                            c += 2
                                        ) {
                                            var d = [
                                            ...
                                            f - 4 === c ? (d[3] = d[2]) : c || (d[0] = { x: +a[c], y: +a[c + 1] }),
                                                l.curve(
                                                    (t * (-d[0].x + 6 * d[1].x + d[2].x)) / 6 + r * d[2].x,
                                                    (t * (-d[0].y + 6 * d[1].y + d[2].y)) / 6 + r * d[2].y,
                                                    (t * (d[1].x + 6 * d[2].x - d[3].x)) / 6 + r * d[2].x,
                                                    (t * (d[1].y + 6 * d[2].y - d[3].y)) / 6 + r * d[2].y,
                                                    d[2].x,
                                                    d[2].y,
                                                    !1,
                                                    i[(c + 2) / 2]
                                ...
                                return (
                                    ...
                                    function t(r, o) {
                                        ...
                                        if (a.length) {
                                            ...
                                            if (((r = a[0].pathCoordinates), (o = a[0].valueData), r.length <= 4))
                                    ...
                                    function(t, r) {
                                        for (var o, a, i, s = new n.Svg.Path(), u = 0; u < t.length; u += 2) {
                                            ...
                                            void 0 !== f.value
                                                ? (void 0 === i
                                                      ? s.move(l, c, !1, f)
                                                      : (e.postpone ? s.line(l, a, !1, i) : s.line(o, c, !1, f),
                                                        s.line(l, c, !1, f)),
                                                  (o = l),
                                                  (a = c),
                                                  (i = f))
                                                : e.fillHoles || (o = a = i = void 0);
                                        }
                                        return s;
                                    }
                                );
                                    ...
                                    Object.keys(e).forEach(
                                        function(o) {
                                            function a(e, t) {
                                                ...
                                                e.easing &&
                                                    ((s =
                                                        e.easing instanceof Array ? e.easing : n.Svg.Easing[e.easing]),
                                                    delete e.easing),
                                                    ...
                                                    t &&
                                                        ...
                                                        (u[o] = e.from),
                                                        this.attr(u),
                                                        (i = n.quantity(e.begin || 0).value),
                                                        (e.begin = 'indefinite')),
                                                    (a = this.elem('animate', n.extend({ attributeName: o }, e))),
                                                    t &&
                                                        setTimeout(
                                                            function() {
                                                                try {
                        ...
                        (n.Svg.Path = n.Class.extend({
                            ...
                            arc: function(e, t, n, r, o, i, s, u, l) {
                                return (
                                    a(
                                        'A',
                                        { rx: +e, ry: +t, xAr: +n, lAf: +r, sf: +o, x: +i, y: +s },
                                        this.pathElements,
                                        this.pos++,
                                        u,
                                        l
                            ...
                            transform: function(e) {
                                return (
                                    i(this.pathElements, function(t, n, r, o, a) {
                                        var i = e(t, n, r, o, a);
                                        (i || 0 === i) && (t[n] = i);
                                    }),
                                    this
                            ...
                            parse: function(e) {
                                ...
                                return (
                                    ...
                                    Array.prototype.splice.apply(this.pathElements, a),
                                    (this.pos += o.length),
                                    this
                                );
                            },
                            ...
                            createChart: function(e) {
                                ...
                                (o =
                                    void 0 === e.axisX.type
                                        ...
                                        : e.axisX.type.call(n, n.Axis.units.x, t.normalized.series, l, e.axisX)),
                                    (a =
                                        void 0 === e.axisY.type
                                            ? new n.AutoScaleAxis(
                                                  n.Axis.units.y,
                                            ...
                                            : e.axisY.type.call(n, n.Axis.units.y, t.normalized.series, l, e.axisY)),
                                    o.createGridAndLabels(i, u, this.supportsForeignObject, e, this.eventEmitter),
                                    a.createGridAndLabels(i, u, this.supportsForeignObject, e, this.eventEmitter),
                                    e.showGridBackground &&
                                        n.createGridBackground(i, l, e.classNames.gridBackground, this.eventEmitter),
                                    t.raw.series.forEach(
                                        function(r, i) {
                                            var u = s.elem('g');
                                            u.attr({ 'ct:series-name': r.name, 'ct:meta': n.serialize(r.meta) }),
                                                u.addClass(
                                                    [
                                                        e.classNames.series,
                    ...
                    (function(e, t, n) {
                        ...
                        n.Bar = n.Base.extend({
                            ...
                            createChart: function(e) {
                                ...
                                var a = this.svg.elem('g').addClass(e.classNames.gridGroup),
                                    i = this.svg.elem('g'),
                                ...
                                var m = e.horizontalBars ? h.x1 + l.projectValue(0) : h.y1 - l.projectValue(0),
                                    v = [];
                                f.createGridAndLabels(a, s, this.supportsForeignObject, e, this.eventEmitter),
                                    l.createGridAndLabels(a, s, this.supportsForeignObject, e, this.eventEmitter),
                                    e.showGridBackground &&
                                        n.createGridBackground(a, h, e.classNames.gridBackground, this.eventEmitter),
                                    t.raw.series.forEach(
                                        function(r, o) {
                                            var a,
                                                s,
                                                    ...
                                                    function(i, c) {
                                                        ...
                                                        if (
                                                            ...
                                                            f instanceof n.StepAxis &&
                                                                (f.options.stretch ||
                                                                    (g[f.units.pos] += a * (e.horizontalBars ? -1 : 1)),
                                                                (g[f.units.pos] +=
                                                            ...
                                                            (y = v[c] || m),
                                                            (v[c] = y - (m - g[f.counterUnits.pos])),
                                                            void 0 !== i)
                                                        ) {
                                                            var x = {};
                                                            (x[f.units.pos + '1'] = g[f.units.pos]),
                                                                (x[f.units.pos + '2'] = g[f.units.pos]),
                                                                !e.stackBars ||
                                                                ('accumulate' !== e.stackMode && e.stackMode)
                                                                    ? ((x[f.counterUnits.pos + '1'] = m),
                                                                      (x[f.counterUnits.pos + '2'] =
                                                                          g[f.counterUnits.pos]))
                                                                    : ((x[f.counterUnits.pos + '1'] = y),
                                                                      (x[f.counterUnits.pos + '2'] = v[c])),
                                                                (x.x1 = Math.min(Math.max(x.x1, h.x1), h.x2)),
                                                                (x.x2 = Math.min(Math.max(x.x2, h.x1), h.x2)),
                                                                (x.y1 = Math.min(Math.max(x.y1, h.y2), h.y1)),
                                                                (x.y2 = Math.min(Math.max(x.y2, h.y2), h.y1));
                                                            var w = n.getMetaData(r, c);
                                                            (b = s
                                                                .elem('line', x, e.classNames.bar)
                                                                .attr({
                                                                    'ct:value': [i.x, i.y]
                                                                        .filter(n.isNumeric)
                                                                        .join(','),
                        ...
                        n.Pie = n.Base.extend({
                            ...
                            createChart: function(e) {
                                ...
                                (this.svg = n.createSvg(
                                    ...
                                    (a = n.createChartRect(this.svg, e, r.padding)),
                                    (i = Math.min(a.width() / 2, a.height() / 2)),
                                    (u =
                                        e.total ||
                                ...
                                '%' === d.unit && (d.value *= i / 100),
                                    (i -= e.donut && !e.donutSolid ? d.value / 2 : 0),
                                    (s =
                                ...
                                l.raw.series.forEach(
                                    ...
                                    l.raw.series.forEach(
                                        function(r, a) {
                                            if (0 !== l.normalized.series[a] || !e.ignoreEmptyValues) {
                                                c[a].attr({ 'ct:series-name': r.name }),
                                                    c[a].addClass(
                                                        [
                                                            e.classNames.series,
                                                            r.className ||
                                                ...
                                                var g,
                                                    ...
                                                    w = new n.Svg.Path(!e.donut || e.donutSolid)
                                                        .move(x.x, x.y)
                                                        .arc(i, i, 0, m - f > 180, 0, _.x, _.y);
                                                e.donut
                                                    ? e.donutSolid &&
                                                      ((y = i - d.value),
                                                      ...
                                                      (b = n.polarToCartesian(p.x, p.y, y, m)),
                                                      w.line(g.x, g.y),
                                                      w.arc(y, y, 0, m - f > 180, 1, b.x, b.y))
                                                    : w.line(p.x, p.y);
                                                var k = e.classNames.slicePie;
                                                e.donut &&
                                                    ((k = e.classNames.sliceDonut),
                                                    e.donutSolid && (k = e.classNames.sliceDonutSolid));
                                                ...
                                                if (
                                                    ...
                                                    e.donut &&
                                                        !e.donutSolid &&
                                                        (E._node.style.strokeWidth = d.value + 'px'),
                                                    this.eventEmitter.emit('draw', {
                                                        type: 'slice',
                                                    ...
                                                    (O =
                                                        ...
                                                        (S =
                                                            l.normalized.labels &&
                                                            !n.isFalseyButZero(l.normalized.labels[a])
                                                                ? l.normalized.labels[a]
                                                                : l.normalized.series[a]);
                                    ...
                                    this.eventEmitter.emit('created', { chartRect: a, svg: this.svg, options: e });
                            },
        ...
        var l = i.default.bind(s.default),
            c = function(e) {
                ...
                return r.default.createElement(
                    ...
                    r.default.createElement(
                        'li',
                        { className: l('summary-item', 'duration'), title: 'Duration' },
                        r.default.createElement(a.Icon, { name: 'timer', className: l('icon'), size: 18 }),
                        r.default.createElement(a.Duration, { timer: n })
                    ),
                    r.default.createElement(
                        'li',
                        { className: l('summary-item', 'tests'), title: 'Tests' },
                        r.default.createElement(a.Icon, { name: 'assignment', className: l('icon'), size: 18 }),
                        o
                    ),
                    !!i &&
                        r.default.createElement(
                            'li',
                            { className: l('summary-item', 'passed'), title: 'Passed' },
                            r.default.createElement(a.Icon, { name: 'check', className: l('icon'), size: 18 }),
                            i
                        ),
                    !!s &&
                        r.default.createElement(
                            'li',
                            { className: l('summary-item', 'failed'), title: 'Failed' },
                            r.default.createElement(a.Icon, { name: 'close', className: l('icon'), size: 18 }),
                            s
                        ),
                    !!u &&
                        r.default.createElement(
                            'li',
                            { className: l('summary-item', 'pending'), title: 'Pending' },
                            r.default.createElement(a.Icon, { name: 'pause', className: l('icon'), size: 18 }),
                            u
                        ),
                    !!c &&
                        r.default.createElement(
                            'li',
                            { className: l('summary-item', 'skipped'), title: 'Skipped' },
                            r.default.createElement(a.Icon, { name: 'stop', className: l('icon'), size: 18 }),
                            c
                        )
                );
            };
    ...
    function(e, t, n) {
        ...
        function c(e) {
            var t = e.active,
                ...
                c = e.iconClassName,
                f = e.toggleFn,
                d = l('label', { 'with-icon': !!u }, i);
            return r.default.createElement(
                'div',
                { className: l('component', n, { disabled: o }) },
                !!u && r.default.createElement(a.Icon, { name: u, className: l('icon', c) }),
                !!s && r.default.createElement('span', { className: d }, s),
                r.default.createElement(
                    'div',
                    {
    ...
    function(e, t, n) {
        ...
        var f = function(e, t, n, r) {
            ...
            c(
                    ...
                    function e() {
                        ...
                        !(function(e, t) {
                            ...
                            (this._mapSuite = function(e) {
                                ...
                                return o.length || a.length || r.length || n.length
                                    ? Object.assign({}, e, { suites: n, beforeHooks: o, afterHooks: a, tests: r })
                                    : null;
                            }),
                ...
                'openSideNav',
                [r],
                Object.getOwnPropertyDescriptor(s.prototype, 'openSideNav'),
                s.prototype
            ),
            c(
                s.prototype,
                'closeSideNav',
                [o],
                Object.getOwnPropertyDescriptor(s.prototype, 'closeSideNav'),
                s.prototype
            ),
            c(
                s.prototype,
                'toggleFilter',
                [a],
                Object.getOwnPropertyDescriptor(s.prototype, 'toggleFilter'),
                s.prototype
            ),
            c(
                s.prototype,
                'setShowHooks',
                [i],
                Object.getOwnPropertyDescriptor(s.prototype, 'setShowHooks'),
                s.prototype
            ),
            c(
                s.prototype,
                'toggleIsLoading',
                [l.action],
                Object.getOwnPropertyDescriptor(s.prototype, 'toggleIsLoading'),
                s.prototype
            ),
            s);
        t.default = d;
